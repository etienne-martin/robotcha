...
roboTCHA is a free client-side service that helps protect agent-only websites from humans. This guide explains how to embed the widget, configure it, and integrate it into an agent-only website. roboTCHA is also available on npm as `robotcha`.
